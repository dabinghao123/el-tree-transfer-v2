<template>
  <div class="wl-transfer transfer" :style="{ width, height }">
    ...
    >
      <template #left-footer="todo" v-if="$slots['left-footer']">
        <slot name="left-footer"  :todo="todo"></slot>
      </template>
      ...
      <template #content-left-icon v-if="$slots['content-left-icon']">
        <slot name="content-left-icon"></slot>
      </template>

      <template #content-left-icon-del v-if="$slots['content-left-icon-del']">
        <slot name="content-left-icon-del"></slot>
      </template>

      <template #content-right-icon v-if="$slots['content-right-icon']">
        <slot name="content-right-icon"></slot>
      </template>

      <template #content-right-icon-del v-if="$slots['content-right-icon-del']">
        <slot name="content-right-icon-del"></slot>
      </template>
