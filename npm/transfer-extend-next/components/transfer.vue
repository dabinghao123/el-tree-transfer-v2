  ...
  <div class="component-transfer">
    ...
    <div class="transfer-left">
      ...
      <div class="transfer-main">
        ...
        <el-tree-v2 style="height: calc(100% - 41px);" ref="from-tree" show-checkbox :lazy="lazy" :indent="indent"
    ...
    <div class="transfer-center">
      ...
      <template v-else>
        <p class="transfer-center-item">
          <el-button type="primary" @click="addToAims(true)" icon="el-icon-arrow-right" circle
    ...
    <div class="transfer-right">
      ...
      <div class="transfer-main">
        ...
        <el-input v-if="filter" clearable size="small" v-model="filterTo" :placeholder="placeholder"
          class="filter-tree"></el-input>
        <el-tree-v2 style="height: calc(100% - 41px);" slot="to" ref="to-tree" show-checkbox :indent="indent"
          :draggable="draggable" :allow-drag="allowDrag" :allow-drop="allowDrop" :icon-class="iconClass"
        ...
        <slot name="right-footer" data="hello"></slot>
      </div>
    </div>
  </div>
</template>
